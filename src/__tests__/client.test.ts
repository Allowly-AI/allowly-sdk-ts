...
describe("Allowly.receipts.get", () => {
  ...
  it("returns signed envelope", async () => {
    const signedReceipt = { schema_version: "2.1.0", receipt_id: "rcp_abc", decision: "allow", alg: "Ed25519", key_id: "k", signature: "sig" };
...
describe("Allowly.receipts.fetchSigned", () => {
  it("polls until signed and returns receipt dict", async () => {
    const signedReceipt = { schema_version: "2.1.0", receipt_id: "rcp_abc" };
    let call = 0;
